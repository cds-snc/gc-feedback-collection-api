...
def detect_device_and_browser(user_agent: str) -> tuple:
    ...
    device_pattern = r"(iPad|iPhone|Android|Windows Phone|Windows NT|Linux|Macintosh|Windows)"
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    """
    try:
        logger.info(f"Date and time format: {datetime.utcnow().strftime('%Y-%m-%d %H:%M')}")
        ...
        required_fields = ['submissionPage', 'pageTitle', 'institutionopt', 'details', 'helpful']
